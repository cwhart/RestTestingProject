...
INSERT INTO RoomRate (RoomID, DefaultFlag, StartDate, EndDate, Price)
VALUES (1, 'D', '2018-01-01', null, '99'),
(2, 'D', '2018-01-01', null, '139'),
(3, 'D', '2018-01-01', null, '99'),
(4, 'D', '2018-01-01', null, '99'),
(5, 'D', '2018-01-01', null, '199'),
(1, 'S','2018-05-02', '2018-9-30', '149'),
(2, 'S','2018-01-01', '2018-5-1', '89'),
(3, 'S', '2018-01-01', '2018-5-1', '79'),
(4, 'S', '2018-01-01', '2018-5-1', '169'),
(5, 'S', '2018-1-01', '2018-12-31', '210');
...
INSERT INTO AddOnRate (AddOnId, DefaultFlag, StartDate, EndDate, Price)
VALUES (1, 'D', '2018-1-1', null, 5),
(1, 'S', '2018-6-1', '2018-12-31', 5),
(2, 'D', '2018-1-1', null, 15),
(3, 'D', '2018-1-1', null, 50),
(3, 'S', '2018-1-1', '2018-7-31', 60),
(4, 'D', '2018-1-1', null, 30),
(4, 'S', '2018-6-1', '2018-12-31', 35),
(5, 'D', '2018-1-1', '2018-12-31', 90);

INSERT INTO Tax (Type, State, StartDate, EndDate, Rate)
VALUES ('Meals', 'NH', '2017/1/20', null, 6.2),
('Rooms', 'NH', '2018/1/1', null, 8.0);
...
INSERT INTO Bill (ReservationID, Total)
VALUES (1, 586.72),
(2, 586.72),
(3, 586.72),
(4, 586.72),
...
INSERT INTO RoomBillDetail (TaxID, PromoID, RoomRateID, BillId, TaxAmount, Price, TransactionDate)
...
INSERT INTO AddOnBillDetail (TaxID, PromoID, AddOnRateID, BillId, TaxAmount, Price, TransactionDate)
VALUES
...
(select (sum(AddOnBillDetail.Price) + 
	(select sum(RoomBillDetail.price) from RoomBillDetail where id=4)) 
as TotalBill
