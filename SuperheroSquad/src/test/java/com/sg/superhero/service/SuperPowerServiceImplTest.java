...
public class SuperPowerServiceImplTest {
    ...
    public void create() {
        ...
        superPowerService.create(superPower);

        //Act
        SuperPower createdSuperPower = superPowerService.create(superPower);
    ...
    public void read() {
        ...
        //Act
        SuperPower readSuperPower = superPowerService.retrieve(superPower.getId());
    ...
    public void delete() {
        ...
        //Act
        assert (superPowerService.retrieve(superPower.getId()) != null);
        superPowerService.delete(superPower);
