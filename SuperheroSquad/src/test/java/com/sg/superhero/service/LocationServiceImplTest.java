...
public class LocationServiceImplTest {
    ...
    public void retrieve() {
        ...
        //Act
        Location readLocation = locationService.retrieve(location.getId());
    ...
    public void delete() {
        ...
        //Act
        assert (locationService.retrieve(location.getId()) != null);
...
//    }
    ...
    public void retrieveLocationBySuper() {
        ...
        //Act
        List<Location> returnedLocationList1 = locationService.retrieveLocationBySuper(superList.get(0), Integer.MAX_VALUE, 0);
        List<Location> returnedLocationList2 = locationService.retrieveLocationBySuper(superList.get(1), Integer.MAX_VALUE, 0);
