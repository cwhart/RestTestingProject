...
public class OrganizationDaoImplTest {
    ...
    public void create() {
        ...
        //Act
        Organization createdOrganization = organizationDao.create(organization);
    ...
    public void retrieve() {
        ...
        //Act
        Organization readOrganization = organizationDao.retrieve(organization.getId());
    ...
    public void getOrganizationsBySuper() {
        ...
        //Act
        List<Organization> orgList = organizationDao.retrieveOrganizationsBySuper(superPerson, Integer.MAX_VALUE, 0);
